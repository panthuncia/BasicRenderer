...
struct CLodReyesTelemetry
{
    ...
    uint firstOwnedVisibleClusterIndex;
    uint firstOwnedInstanceID;
    uint firstOwnedMaterialIndex;
    uint firstHistogramReadVisibleClusterIndex;
    uint firstHistogramReadInstanceID;
    uint firstHistogramReadMaterialIndex;
    uint histogramInvocationCount;
    uint histogramObservedClusterCount;
    uint histogramReadOwnedClusterMatchCount;
    uint histogramOwnedClusterBitValue;
    uint firstCompactionReadVisibleClusterIndex;
    uint firstCompactionReadInstanceID;
    uint firstCompactionReadMaterialIndex;
    uint compactionInvocationCount;
    uint compactionObservedClusterCount;
    uint compactionReadOwnedClusterMatchCount;
    uint compactionOwnedClusterBitValue;
    uint ownershipBitSetUniqueCount;
    uint ownershipBitSetDuplicateCount;
    uint ownershipBitSetOutOfRangeCount;
    uint ownershipBitSetMaxIndex;
    uint histogramReyesOwnedSkipCount;
    uint compactionReyesOwnedSkipCount;
    uint firstHistogramSkippedVisibleClusterIndex;
    uint firstHistogramSkippedInstanceID;
    uint firstHistogramSkippedMaterialIndex;
    uint firstCompactionSkippedVisibleClusterIndex;
    uint firstCompactionSkippedInstanceID;
    uint firstCompactionSkippedMaterialIndex;
