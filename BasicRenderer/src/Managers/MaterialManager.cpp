...
MaterialManager::MaterialManager() {
	...
	m_perMaterialDataBuffer = rm.CreateIndexedDynamicStructuredBuffer<PerMaterialCB>(m_compileFlagsSlotsUsed, L"Builtin::PerMaterialDataBuffer", true);

	// Visibility buffer resources
    m_materialPixelCountBuffer = rm.CreateIndexedDynamicStructuredBuffer<uint32_t>(m_compileFlagsSlotsUsed, L"VisUtil::MaterialPixelCountBuffer", true);
    m_materialOffsetBuffer = rm.CreateIndexedDynamicStructuredBuffer<uint32_t>(m_compileFlagsSlotsUsed, L"VisUtil::MaterialOffsetBuffer", true);
	m_materialWriteCursorBuffer = rm.CreateIndexedDynamicStructuredBuffer<uint32_t>(m_compileFlagsSlotsUsed, L"VisUtil::MaterialWriteCursorBuffer", true);
	...
	m_materialEvaluationCommandBuffer = rm.CreateIndexedDynamicStructuredBuffer<MaterialEvaluationIndirectCommand>(m_compileFlagsSlotsUsed, L"IndirectCommandBuffers::MaterialEvaluationCommandBuffer", true);
