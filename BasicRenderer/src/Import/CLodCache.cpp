...
namespace CLodCache {
	...
	uint64_t ComputeBuildConfigHash()
	{
		...
		boost::hash_combine(seed, static_cast<uint32_t>(6));  // multi-UV + 8-influence skinned CLod page stream format version
		...
		boost::hash_combine(seed, static_cast<uint32_t>(9));  // streamable voxel groups + refined-child voxel acceptance diagnostics
