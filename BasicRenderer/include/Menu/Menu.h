...
inline void Menu::Render(const RenderContext& context) {
    ...
    CD3DX12_CPU_DESCRIPTOR_HANDLE rtvHandle(rhi::dx12::get_descriptor_heap(context.rtvHeap)->GetCPUDescriptorHandleForHeapStart(), context.frameIndex, context.rtvDescriptorSize);
