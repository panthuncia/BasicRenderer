...
public:
    ...
    PassReturn Execute(PassExecutionContext& context) override {
        ...
        passConstants[TIME_COEFFICIENT] = contextRef.deltaTime;

		passConstants[NUM_PIXELS] = static_cast<float>(contextRef.renderResolution.x * contextRef.renderResolution.y);
