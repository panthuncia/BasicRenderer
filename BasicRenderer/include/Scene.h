...
public:
    ...
    UINT GetNumLights();
    UINT GetLightBufferDescriptorIndex(uint8_t frameIndex);
    UINT GetPointCubemapMatricesDescriptorIndex(uint8_t frameIndex);
    UINT GetSpotMatricesDescriptorIndex(uint8_t frameIndex);
    UINT GetDirectionalCascadeMatricesDescriptorIndex(uint8_t frameIndex);
    void PostUpdate();
