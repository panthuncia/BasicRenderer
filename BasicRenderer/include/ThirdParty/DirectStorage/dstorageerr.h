...
//
// MessageId: E_DSTORAGE_SCRATCH_BUFFER_TOO_SMALL
//
// MessageText:
//
// The scratch buffer given to the driver is too small
// to decompress buffers successfully.
//
#define E_DSTORAGE_SCRATCH_BUFFER_TOO_SMALL ((HRESULT)0x89240042L)

//
// MessageId: E_DSTORAGE_INVALID_GACL_SHUFFLE_TRANSFORM_TYPE
//
// MessageText:
//
// A request with a GACL shuffle transform type other than DSTORAGE_GACL_SHUFFLE_TRANSFORM_NONE
// was enqueued without DSTORAGE_COMPRESSION_FORMAT_ZSTD, or was enqueued into a queue that
// doesn't have a D3D device, has a D3D device that doesn't support GACL shuffle transforms,
// or has a D3D device that doesn't support ZSTD GPU decompression.
//
#define E_DSTORAGE_INVALID_GACL_SHUFFLE_TRANSFORM_TYPE ((HRESULT)0x89240043L)
