...
#define DSTORAGE_SDK_VERSION 400
...
enum DSTORAGE_COMPRESSION_FORMAT : UINT8 {
    ...
    /// <summary>
    /// The data is compressed using Zstd format.
    /// </summary>
    DSTORAGE_COMPRESSION_FORMAT_ZSTD     = 2,
...
/// <summary>
/// The Game Asset Conditioning Library shuffle transform type applied to the source data. The transform will
/// be reversed by DirectStorage before the data is written to the destination.
/// </summary>
enum DSTORAGE_GACL_SHUFFLE_TRANSFORM_TYPE : UINT8
{
    /// <summary>
    /// No GACL shuffle transform.
    /// </summary>
    DSTORAGE_GACL_SHUFFLE_TRANSFORM_NONE = 0,

    /// <summary>
    /// GACL shuffle transform for BC1 format.
    /// </summary>
    DSTORAGE_GACL_SHUFFLE_TRANSFORM_BC1 = 1,

    /// <summary>
    /// GACL shuffle transform for BC3 format.
    /// </summary>
    DSTORAGE_GACL_SHUFFLE_TRANSFORM_BC3 = 2,

    /// <summary>
    /// GACL shuffle transform for BC4 format.
    /// </summary>
    DSTORAGE_GACL_SHUFFLE_TRANSFORM_BC4 = 3,

    /// <summary>
    /// GACL shuffle transform for BC5 format.
    /// </summary>
    DSTORAGE_GACL_SHUFFLE_TRANSFORM_BC5 = 4,
};
...
struct DSTORAGE_REQUEST_OPTIONS {
    ...
    /// <summary>
    /// DSTORAGE_GACL_SHUFFLE_TRANSFORM_TYPE indicating the shuffle transform type applied to the source data.
    /// </summary>
    DSTORAGE_GACL_SHUFFLE_TRANSFORM_TYPE GaclTransformType : 8;
...
/// <summary>
/// DirectStorage Configuration, with added file buffering option.
/// Zero initializing this will result in the default values.
/// </summary>
...
/// DirectStorage Configuration. Zero initializing this will result in the default values.
/// </summary>
struct DSTORAGE_CONFIGURATION2
{
    /// <summary>
    /// Sets the number of threads to use for submitting IO operations.
    /// Specifying 0 means use the system's best guess at a good value.
    ...
    /// <summary>
    /// Allows applications to specify a global CreatorID that applies to
    /// all D3D12 command queues created by DirectStorage on a per - D3D12
    /// device basis.
    /// </summary>
    GUID CreatorID;
};
...
/// when no queue is created and no files are open,
/// E_DSTORAGE_STAGING_BUFFER_LOCKED is returned if this is not the case.</returns>
HRESULT WINAPI DStorageSetConfiguration2(DSTORAGE_CONFIGURATION2 const* configuration);
